...
remobid.common.ui.control.ControlBase.prototype.bindNode_ = function(node) {
  var attributes = goog.dom.dataset.getAll(node);

  var mapping = goog.object.findValue(this.mappings_, function(mapping) {
  ...
  if (goog.object.containsKey(attributes, 'rbBindSet') ||
      goog.object.containsKey(attributes, 'rbBindGet')) {
    this.getHandler()
      .listen(
        this.getModel(),
